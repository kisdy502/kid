...
public class MessageHelper {
    ...
    public static TransMessageProtobuf.TransMessage getReportStatusMessage(TransMessageProtobuf.TransMessage message) {
        ...
        return buildMessage(message.getMsgId(), 0L, 0L,
    ...
    public static TransMessageProtobuf.TransMessage getGroupCreatedMessage(UserGroup userGroup) {
        return buildMessage(UUID.randomUUID().toString(), 0L, 0L,
    ...
    public static TransMessageProtobuf.TransMessage getRealtionListMessage(List<Friend> friendList) {
        return buildMessage(UUID.randomUUID().toString(), 0L, 0L,
    ...
    public static TransMessageProtobuf.TransMessage getRefuseAddFriendMessage(Long fromId, Long toId) {
        return buildMessage(UUID.randomUUID().toString(), fromId, toId,
    ...
    public static TransMessageProtobuf.TransMessage getAgreeAddFriendMessage(Friend friend, Long fromId, Long toId) {
        return buildMessage(UUID.randomUUID().toString(), fromId, toId,
    ...
    private static TransMessageProtobuf.TransMessage buildMessage(String messageId, Long fromId, Long toId, int type, String content, long sendTime, int reportStatus) {
